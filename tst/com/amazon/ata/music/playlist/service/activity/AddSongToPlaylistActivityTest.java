...
public class AddSongToPlaylistActivityTest {
    ...
    void handleRequest_validRequest_addsSongToEndOfPlaylist() {
        ...
        when(playlistDao.savePlaylist(modelConverter.toPlaylistModel(originalPlaylist))).thenReturn(originalPlaylist);
        ...
        // THEN
        verify(playlistDao).savePlaylist(modelConverter.toPlaylistModel(originalPlaylist));
