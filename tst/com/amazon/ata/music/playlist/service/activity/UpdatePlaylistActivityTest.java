...
public class UpdatePlaylistActivityTest {
    ...
    public void handleRequest_goodRequest_updatesPlaylistName() {
        ...
        PlaylistModel endingPlaylistModel = new PlaylistModel();
        endingPlaylistModel.setId(id);
        endingPlaylistModel.setName(expectedName);
        endingPlaylistModel.setCustomerId(expectedCustomerId);

        Playlist endingPlaylist = new Playlist();
        endingPlaylist.setId(id);
        endingPlaylist.setName(expectedName);
        endingPlaylist.setCustomerId(expectedCustomerId);

        when(playlistDao.getPlaylist(id)).thenReturn(startingPlaylist);
        when(playlistDao.savePlaylist(endingPlaylistModel)).thenReturn(endingPlaylist);
